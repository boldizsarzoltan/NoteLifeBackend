...
#[get("/all")]
pub async fn get_all_user_events_endpoint(user: AuthenticatedUser) -> Result<Json<Vec<EventDTO>>, String> {
...
pub async fn add_user_event_endpoint(new_event: Json<NewEventDTO>, user: AuthenticatedUser) -> Result<Json<EventDTO>, String> {
...
pub async fn update_user_event_endpoint(event: Json<EventDTO>, user: AuthenticatedUser) -> Result<Json<EventDTO>, String> {
...
#[delete("/<event_id>")]
pub(crate) async fn delete_event_endpoint(event_id: i32, user: AuthenticatedUser) -> Result<String, String> {
